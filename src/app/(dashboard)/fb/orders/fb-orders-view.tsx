...
export default function FbOrdersView({
  orders,
  stats,
  date,
  paymentStatus,
  ...
  onHandleUpdateStatus: (formData: FormData) => Promise<void>;
}) {
  function confirmMarkPaid(e: React.FormEvent) {
