    ...
    <div className="p-4 md:p-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <h1 className="text-xl font-bold flex items-center gap-2" style={{ color: '#0f1a3c' }}>
          <i className="fas fa-layer-group" style={{ color: '#c9a96e' }}></i>
      ...
      <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {categories.length === 0 ? (
                <tr><td colSpan={5} className="text-center py-10 text-gray-400 text-sm">No categories found</td></tr>
              ) : (
                categories.map((cat) => (
        ...
        <div className="bg-white rounded-2xl overflow-hidden">
          ...
          <form action={onHandleCreateCategory} className="p-5 space-y-4">
            <div>
              ...
              <input type="text" name="name" required placeholder="e.g. Cleaning Supplies" className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm" />
            </div>
            <div>
