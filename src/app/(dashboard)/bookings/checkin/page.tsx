  ...
  try {
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-xl shadow-sm p-5">
              ...
              <p className="text-[10px] text-gray-400 mb-4">
                ...
                Early check-in (before 12:00 PM) incurs a 25% fee on the nightly rate.
              </p>
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm p-10 text-center">
        ...
        <a href="/bookings/checkin" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-semibold text-white" style={{ background: '#0f1a3c' }}>
